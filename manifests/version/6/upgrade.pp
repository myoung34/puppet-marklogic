# == class Marklogic::version::6::upgrade
#
...
#
class marklogic::version::6::upgrade inherits marklogic::activator {
  ...
  Package['MarkLogic'] -> Exec['manually_restart_service'] ->
    Exec['accept_license'] -> Exec['upgrade_databases']
}
